...
dds_qos_t * qos = dds_create_qos();
 ...
 dds_qset_prop(qos, "dds.sec.auth.identity_ca", "/usr/local/cyclonedds/examples/roundtrip/Local_Certs/axolotlpi01_CA_cert.pem");
 dds_qset_prop(qos, "dds.sec.auth.private_key", "/usr/local/cyclonedds/examples/roundtrip/Local_Certs/axolotlpi03_priv_key.pem");
 dds_qset_prop(qos, "dds.sec.auth.identity_certificate", "/usr/local/cyclonedds/examples/roundtrip/Local_Certs/axolotlpi03_cert.pem");
...
dds_qset_prop(qos, "dds.sec.access.permissions_ca", "/usr/local/cyclonedds/examples/roundtrip/Local_Certs/axolotlpi01_permissions_CA_cert.pem");
dds_qset_prop(qos, "dds.sec.access.governance", "/usr/local/cyclonedds/examples/CA_Cert/Test_Governance.p7s");
dds_qset_prop(qos, "dds.sec.access.permissions", "/usr/local/cyclonedds/examples/CA_Cert/Test_Permissions.p7s");
